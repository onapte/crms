...
<div id="main-div-2">
	...
	<?php foreach ($criminals as $criminal) { ?>
		<div class="div-2">
			<?php
			echo "<div style='width: 30px' id='img_div'>";
			echo "<img src='images/" . $criminal['image'] . "' >";
			echo "</div>";
			?>
			
			<p><b>Criminal Name: </b><?php echo htmlspecialchars($criminal['Crimname']); ?></p>
			...
			<p><b>Crimes Comitted: </b><?php echo htmlspecialchars($criminal['crimes_com']); ?></p>
